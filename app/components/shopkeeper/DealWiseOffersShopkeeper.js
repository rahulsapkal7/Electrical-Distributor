...
import {NavigationActions} from 'react-navigation';
 ...
 class DealWiseOffersShopkeeper extends Component {
  ...
  componentDidMount() {
      ...
      getPendingOrderList = () =>{
        const url = api() + 'ViewDealsWiseOffer.php';
         console.log(url);
...
export default connect(mapStateToProps, mapDispatchToProps)(DealWiseOffersShopkeeper);