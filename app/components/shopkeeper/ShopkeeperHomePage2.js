 ...
 class ShopkeeperHomePage2 extends Component {
  ...
  render() {
    return (
      ...
      title="Proton enterprise"
      actions={[{title: 'Settings', icon: require('../../assets/images/crescent.png'), show: 'always'},
      {title: 'My profile', icon: require('../../assets/images/crescent.png'), show: 'always'},
      {title: 'Notifications', icon: require('../../assets/images/crescent.png'), show: 'always'}]}
      onActionSelected={this.onActionSelected} />
        ...
        />
               ...
               <Image source={require('../../assets/images/top_offer.png')} style={styles.backgroundImage}>
