...
import {NavigationActions} from 'react-navigation';
 ...
 class BrandWiseOfferShopkeeper extends Component {
  ...
  componentDidMount() {
      ...
      getPendingOrderList = () =>{
        const url = api() + 'ViewBrandWiseOffer.php';
         console.log(url);
...
export default connect(mapStateToProps, mapDispatchToProps)(BrandWiseOfferShopkeeper);